...
function collide(body,sprite){//Argumentos fruta y conejito respectivamente
  //Condición para verificar si el cuerpo (fruta) existe o no
  if(body!=null){ //Operador NO IGUAL A un valor determinado
    //Para comprobar la colisión usaremos "dist" que nos ayuda a medir la 
    //distancia entre la fruta y el conejito usando la posicion de cada uno
